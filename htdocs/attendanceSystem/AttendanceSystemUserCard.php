...
$langs->load("attendancesystemuser@attendanceSystem");
   ...
   case 'delete';
    ...
    case 'view':
    {
        ...
        if($edit == 0 && $new == 0){ //show tabs
            ...
            dol_fiche_head($head, 'card', $langs->trans('AttendanceSystemUser'),0, 'attendanceSystem@attendanceSystem');            
        }else{
	...
	print '<br>';
        if($edit == 1){
            ...
            $basedurl = dol_buildpath("/attendanceSystem/AttendanceSystemUserList.php", 1);
...
// show the field mode
	...
	print '<div class="center">';
        ...
        print_fiche_titre($langs->trans('AttendanceSystemUser'));
        $head = AttendanceSystemUserPrepareHead($object);
        dol_fiche_head($head, 'info', $langs->trans("AttendanceSystemUser"),0, 'attendanceSystem@attendanceSystem');            
