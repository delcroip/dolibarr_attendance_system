...
$langs->load("attendancesystemuserlink@attendanceSystem");
   ...
   case 'delete';
    ...
    case 'view':
    {
        ...
        if($edit == 0 && $new == 0){ //show tabs
            ...
            dol_fiche_head($head, 'card', $langs->trans('AttendanceSystemUserLink'),0, 'attendanceSystem@attendanceSystem');            
        }else{
	...
	print '<br>';
        if($edit == 1){
            ...
            $basedurl = dol_buildpath("/attendanceSystem/AttendanceSystemUserLinkList.php", 1);
...
print "\n</tr>\n";
	...
	print '<div class="center">';
        ...
        print_fiche_titre($langs->trans('AttendanceSystemUserLink'));
        $head = AttendanceSystemUserLinkPrepareHead($object);
        dol_fiche_head($head, 'info', $langs->trans("AttendanceSystemUserLink"),0, 'attendanceSystem@attendanceSystem');            
