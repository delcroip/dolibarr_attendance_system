...
$langs->load("attendancesystemevent@attendanceSystem");
   ...
   case 'delete';
    ...
    case 'view':
    {
        ...
        if($edit == 0 && $new == 0){ //show tabs
            ...
            dol_fiche_head($head, 'card', $langs->trans('AttendanceSystemEvent'),0, 'attendanceSystem@attendanceSystem');            
        }else{
	...
	print '<br>';
        if($edit == 1){
            ...
            $basedurl = dol_buildpath("/attendanceSystem/AttendanceSystemEventList.php", 1);
...
// show the field status
	...
	print '<div class="center">';
        ...
        print_fiche_titre($langs->trans('AttendanceSystemEvent'));
        $head = AttendanceSystemEventPrepareHead($object);
        dol_fiche_head($head, 'info', $langs->trans("AttendanceSystemEvent"),0, 'attendanceSystem@attendanceSystem');            
