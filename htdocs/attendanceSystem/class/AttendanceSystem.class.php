...
class AttendanceSystem extends CommonObject
{
    ...
    function getNomUrl($htmlcontent, $id = 0, $ref = '', $withpicto = 0)
    {
        ...
        $lien = '<a href = "'.dol_buildpath('/attendanceSystem/AttendanceSystemCard.php',1).'?id='.$id.'&action=view"'.$linkclose.'>';
...
// Commit or rollback
    ...
    */
    ...
    public function testConnection(){
        ...
        /** function to return the task on which the time need to be put
         * 
         *  @result 
         */
        public function getTask(){
            // FIXME support project ... 
            return $this->task;
        }
